...
folder = "../results/cond_bal/"
experiment_name = "cond_bal"
...
experiments_name = ["staggered_overlap_parallelVertex_16","hyperPraw_default_lambda0_16","hyperPraw_default_lambda1_16","hyperPraw_default_lambda10_16","hyperPraw_bandwidth_lambda0_16","hyperPraw_bandwidth_lambda1_16","hyperPraw_bandwidth_lambda10_16"]
experiments_partitioning = ["parallelVertex","hyperPrawVertex","hyperPrawVertex","hyperPrawVertex","hyperPrawVertex","hyperPrawVertex","hyperPrawVertex"]
colours = ["black","tomato","yellow","seagreen","red","blue","pink"] # as many as the number of experiments included
patterns = ["//" , "||" , "--" , "xx" , "//" , "||","--"  ]
legend_labels = ['default1','hyperPraw-default0','HyperPraw-default1','HyperPraw-default10','HyperPraw-bandwidth0','HyperPraw-bandwidth1','HyperPraw-bandwidth10']
