...
folder = "../results/rep_comm/"
experiment_name = "rep_comm"
...
experiments_name = ["staggered_overlap_parallelVertex_1","staggered_overlap_parallelVertex_16","hyperPraw_default_1","hyperPraw_default_16","hyperPraw_bandwidth_1","hyperPraw_bandwidth_16"]#,"hyperPraw_bandwidth_lambda10_1"]
experiments_partitioning = ["parallelVertex","parallelVertex","hyperPrawVertex","hyperPrawVertex","hyperPrawVertex","hyperPrawVertex","hyperPrawVertex"]
colours = ["black","tomato","yellow","seagreen","red","blue","pink"] # as many as the number of experiments included
patterns = ["//" , "||" , "--" , "xx" , "//" , "||","--"  ]
legend_labels = ['default1','default16','hyperPraw-default1','HyperPraw-default16','HyperPraw-bandwidth1','HyperPraw-bandwidth16','HyperPraw-bandwidth1','HyperPraw-bandwidth10']
