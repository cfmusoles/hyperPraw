#ifndef PARALLEL_HYPERPRAW_PARTITION_PARTITIONING
#define PARALLEL_HYPERPRAW_PARTITION_PARTITIONING
...
public:
	...
	virtual ~ParallelHyperPRAWPartitioning() {
	...
	virtual void perform_partitioning(int num_partitions,int process_id, int* iterations) {
        ...
        if(is_active) {
            ...
            int* vtx_wgt = (int*)calloc(num_elements,sizeof(int));
