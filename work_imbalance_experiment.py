...
run_experiment() {
	...
	aprun -n $PROCESSES hyperPraw -n $NAME -h $HYPERGRAPH_FILE -i 100 -m $IMBALANCE_TOLERANCE -p prawE -t $E_SIM_STEPS -s $SEED -k $MESSAGE_SIZE -o 2 -b $BM_FILE -W -r 950 -f $MEAN_WORKLOAD -u $STD_WORKLOAD
	sleep 1
}
