...
run_experiment() {
	...
	do
		...
		sleep 1
		if [[ $COMPLETE_WINDOW_SCALING == "yes" ]]; then
...
do
	SEED=$RANDOM
	#synthetic graphs
	run_experiment "huge_uniform_dense_c96.hgr" $SEED 1 0 850 "yes"
	run_experiment "huge_uniform_packed_c192.hgr" $SEED 1 0 1050 "no"
